...
def main():
    ...
    configs = [
        {'num_samples': 200, 'model_name': 'model_200'},
        {'num_samples': 1000, 'model_name': 'model_1000'},
        {'num_samples': 50000, 'model_name': 'model_50000'},
    ]
    ...
    for config in configs:
        ...
        print(f"\n{'='*60}")
        print(f"Training model with {num_samples} samples: {model_name}")
        print(f"{'='*60}")
